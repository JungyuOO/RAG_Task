...
class PromptComposer:
    ...
    def build_system_prompt(
        ...
        system_prompt = (
            ...
            "When section titles, section paths, viewer paths, or source URLs are present in the retrieved context, use them to stay tightly grounded to the cited section. "
            "Prefer section-grounded wording such as '해당 섹션에서는 ...' over generic document-level wording. "
            ...
            "When retrieved context is used, end the answer with a short source line such as '[file.md] p.5' or '[file.md] p.5-6'. "
