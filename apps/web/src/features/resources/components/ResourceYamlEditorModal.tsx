...
import type { OcpActionPreviewResponse } from "@/features/actions/types";
import type { OcpLiveResourceDetailResponse, OcpLiveResourceSummary } from "@/features/connection/types";
...
export function ResourceYamlEditorModal({
  ...
  return (
    <Dialog open={open} onOpenChange={(nextOpen) => { if (!nextOpen) onClose(); }}>
      <DialogContent className="grid w-[min(100vw-2rem,72rem)] max-w-none grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden border-border/70 bg-card p-0">
